    ...
    <div className="w-full bg-deep-black text-warm-100 overflow-hidden">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12 text-center flex flex-col items-center mt-20">
          ...
          <motion.h1
            ...
            className="text-6xl md:text-8xl lg:text-9xl font-serif text-white mb-8 leading-[1.1] max-w-6xl tracking-tight"
          >
            Where Faith Meets <br />
            <span className="text-gradient-gold italic pr-4">the Divine</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-warm-200/80 text-xl md:text-3xl max-w-3xl mx-auto mb-12 font-light leading-relaxed"
          >
            Witness the miracle that transformed Vilakkannur into a global pilgrimage destination.
          </motion.p>
        ...
        >
          <span className="text-warm-200/50 text-xs uppercase tracking-widest font-medium">Scroll to Explore</span>
          <motion.div
            animate={{ y: [0, 10, 0] }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { 
                ...
                desc: "A serene sanctuary in the hills of Kerala, rooted in deep faith and community heritage.", 
                icon: <MapPin className="w-7 h-7" />,
                glow: "group-hover:shadow-[0_0_40px_rgba(52,211,153,0.15)]",
                gradient: "group-hover:from-emerald-500/10"
              },
              { 
                title: "Pilgrimage Importance", 
                desc: "A global destination for spiritual renewal, healing, and witnessing the Eucharistic Miracle.", 
              ...
              { 
                ...
                desc: "Open daily for pilgrims. Join us for Holy Mass, adoration, and peaceful reflection.", 
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[300px] md:auto-rows-[350px]">
            ...
            >
              <Link to="/miracle" className="block w-full h-full">
                ...
                <div className="absolute bottom-12 left-12 z-10">
                  <span className="text-gold-400 font-serif italic text-xl mb-3 block">The Divine Sign</span>
                  <h3 className="text-5xl font-serif text-white mb-4">The Eucharistic Miracle</h3>
                  <p className="text-warm-200/70 text-lg max-w-md">Witness the profound manifestation of Christ's real presence that drew the world's eyes to Vilakkannur.</p>
                </div>
              </Link>
            </motion.div>
            ...
            >
              <Link to="/about" className="block w-full h-full">
                ...
                <div className="absolute bottom-12 left-10 z-10">
                  <h3 className="text-4xl font-serif text-white mb-4">Spiritual Experience</h3>
                  <p className="text-warm-200/70 text-lg">Find peace and renewal in our vibrant faith community.</p>
                </div>
              </Link>
            </motion.div>
            ...
            >
              <Link to="/visit" className="block w-full h-full">
                ...
                <div className="absolute bottom-10 left-10 z-10">
                  <h3 className="text-3xl font-serif text-white mb-2">Plan Your Visit</h3>
                  <p className="text-warm-200/70">Mass timings and directions</p>
                </div>
              </Link>
            </motion.div>
            ...
            >
              <Link to="/gallery" className="block w-full h-full">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-deep-black via-deep-black/40 to-transparent opacity-90 group-hover:opacity-70 transition-opacity duration-500"></div>
                <div className="absolute bottom-10 left-10 z-10">
                  <h3 className="text-3xl font-serif text-white mb-2">Visual Gallery</h3>
                  <p className="text-warm-200/70">Glimpses of grace</p>
                </div>
              </Link>
            </motion.div>
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          >
            Experience the <span className="text-gradient-gold italic pr-4">Presence</span>
          </motion.h2>
        </div>
      </section>

      {/* 7. Premium CTA */}
      <section className="py-40 relative flex items-center justify-center bg-deep-black">
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="relative bg-ink p-16 md:p-24 rounded-[2.5rem] border border-white/10 text-center glass-dark overflow-hidden">
              {/* Inner glow */}
              ...
              <h2 className="text-5xl md:text-7xl font-serif text-white mb-12 relative z-10 leading-tight">
